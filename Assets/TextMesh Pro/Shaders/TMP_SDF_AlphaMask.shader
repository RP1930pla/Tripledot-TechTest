Shader "TextMeshPro/Distance Field - Alpha Mask" {
...
SubShader {
	...
	Pass {
        ...
        float4 Unity_Blend_Dodge_float4(float4 Base, float4 Blend, float Opacity)
        {
			float4 Out;
            Out = Base / (1.0 - Blend);
		...
		// Alternative implementation to UnityGet2DClipping with support for softness.
			...
			//
			// return half4(screenUV.xy,0,1);
  		    return faceColor * input.color.a * faceColor.a;
		}
		ENDCG
	}
}
